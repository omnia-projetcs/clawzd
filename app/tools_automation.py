...
NODE_TYPES = {
    ...
    "email_send": {"label": "Send Email", "category": "communication", "color": "#8b5cf6",
        ...
        "params": [{"key": "to", "label": "To", "type": "text", "default": "", "description": "The destination email address."},
                   {"key": "subject", "label": "Subject", "type": "text", "default": "", "description": "The email subject line."},
                   {"key": "body", "label": "Body (HTML)", "type": "textarea", "default": "", "description": "The email content in HTML format."},
                   {"key": "template", "label": "Template Name", "type": "text", "default": "", "description": "Optional name of a saved email template to use instead of the body."}]},
    "discord_send": {"label": "Discord Message", "category": "communication", "color": "#5865F2",
        "icon": "discord", "inputs": ["main"], "outputs": ["main"],
        "params": [{"key": "channel_id", "label": "Channel ID", "type": "text", "default": "", "description": "The ID of the Discord channel where the message will be sent."},
                   {"key": "message", "label": "Message", "type": "textarea", "default": "", "description": "The content of the Discord message."}]},
    "signal_send": {"label": "Signal Message", "category": "communication", "color": "#3A76F0",
        "icon": "signal", "inputs": ["main"], "outputs": ["main"],
        "params": [{"key": "recipient", "label": "Recipient (+phone)", "type": "text", "default": "", "description": "The recipient's phone number including the country code (e.g. +123456789)."},
                   {"key": "message", "label": "Message", "type": "textarea", "default": "", "description": "The text message to send via Signal."}]},
    "telegram_send": {"label": "Telegram Message", "category": "communication", "color": "#0088cc",
        "icon": "telegram", "inputs": ["main"], "outputs": ["main"],
        "params": [{"key": "chat_id", "label": "Chat ID", "type": "text", "default": "", "description": "The Telegram Chat ID (or group ID) to send the message to."},
                   {"key": "message", "label": "Message", "type": "textarea", "default": "", "description": "The content of the Telegram message."}]},
    "whatsapp_send": {"label": "WhatsApp Message", "category": "communication", "color": "#25D366",
        "icon": "whatsapp", "inputs": ["main"], "outputs": ["main"],
        "params": [{"key": "recipient", "label": "Recipient (+phone)", "type": "text", "default": "", "description": "The recipient's WhatsApp phone number with country code."},
                   {"key": "message", "label": "Message", "type": "textarea", "default": "", "description": "The text message to send via WhatsApp."}]},
    ...
    "export_email": {"label": "Export by Email", "category": "export", "color": "#ef4444",
        "icon": "send", "inputs": ["main"], "outputs": ["main"],
        "params": [{"key": "to", "label": "To", "type": "text", "default": "", "description": "The destination email address for the exported data."},
                   {"key": "subject", "label": "Subject", "type": "text", "default": "Data Export", "description": "The email subject line."},
                   {"key": "format", "label": "Attachment Format", "type": "select", "options": ["json","csv","txt"], "default": "json", "description": "Format of the exported data file."}]},
    ...
    "medium_publish": {"label": "Publish to Medium", "category": "publish", "color": "#00ab6c",
        ...
        "params": [{"key": "title", "label": "Title", "type": "text", "default": "", "description": "The title of the Medium article."},
                   {"key": "content", "label": "Content (Markdown/HTML)", "type": "textarea", "default": "", "description": "The main content of the article."},
                   {"key": "content_format", "label": "Format", "type": "select", "options": ["markdown", "html"], "default": "markdown", "description": "The formatting style of the content."},
                   {"key": "tags", "label": "Tags (comma-sep)", "type": "text", "default": "", "description": "Comma-separated list of tags (max 5) for the article."},
                   {"key": "publish_status", "label": "Status", "type": "select", "options": ["draft", "public", "unlisted"], "default": "draft", "description": "The visibility status of the published article."}]},
    "twitter_publish": {"label": "Publish to X (Twitter)", "category": "publish", "color": "#000000",
        "icon": "x-twitter", "inputs": ["main"], "outputs": ["main"],
        "params": [{"key": "text", "label": "Tweet Text (280 chars)", "type": "textarea", "default": "", "description": "The content of the tweet (maximum 280 characters)."},
                   {"key": "reply_to", "label": "Reply To (Tweet ID, optional)", "type": "text", "default": "", "description": "Optional ID of a tweet you are replying to."}]},
    "linkedin_publish": {"label": "Publish to LinkedIn", "category": "publish", "color": "#0A66C2",
        "icon": "linkedin", "inputs": ["main"], "outputs": ["main"],
        "params": [{"key": "text", "label": "Post Text", "type": "textarea", "default": "", "description": "The content of the LinkedIn post."},
                   {"key": "visibility", "label": "Visibility", "type": "select", "options": ["PUBLIC", "CONNECTIONS"], "default": "PUBLIC", "description": "Who can see this post (PUBLIC or CONNECTIONS only)."}]},
