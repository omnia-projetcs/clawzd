"""
Clawzd — Dynamic skill creation engine.
Generates, validates, and registers new skills from user-provided specifications.
"""
import os
import re
import logging
from fastapi import HTTPException
from app.skills.model import generate_skill_template, SKILL_CATEGORIES
from app.skills.registry import get_registry, SKILLS_DIR
